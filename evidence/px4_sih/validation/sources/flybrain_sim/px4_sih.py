...
def launch_environment(inherited, low_noise_sensors=False):
...
class OwnedSih:
    ...
    def __init__(self, folder, low_noise_sensors=False):
        ...
        try:
            ...
            env = launch_environment(os.environ, low_noise_sensors)
